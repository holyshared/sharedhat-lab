...
ARTBEAT_API_URL = 'http://www.tokyoartbeater.com'
...
class ArtBeat():
    ...
    >>> artbeat = ArtBeat()
    >>> response = artbeater.eventSearchBear({ 'Latitude': 35.6763, 'Longitude': 139.8105 })
...
if __name__ == '__main__':
    ...
    artbeat = ArtBeat()
    response = artbeater.eventSearchNear(values={ 'Latitude': 35.6763, 'Longitude': 139.8105 })
